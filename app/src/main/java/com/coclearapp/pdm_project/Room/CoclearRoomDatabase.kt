...
import com.coclearapp.pdm_project.Room.Dao.RolDao
import com.coclearapp.pdm_project.Room.Dao.UserDao
import com.coclearapp.pdm_project.Room.Dao.UserXPatientDao
...
@Database(entities = [Patient::class, Rol::class,User::class,UserXPatient::class ], version = 1)
